...
public class operatorController implements Initializable 
{
   ...
   {
	// Lets try to switch scenes
	   Parent newParent = FXMLLoader.load(getClass().getResource("members.fxml"));
   ...
   {
	// Lets try to switch scenes
	   Parent newParent = FXMLLoader.load(getClass().getResource("providers.fxml"));
   ...
   {
	// Lets try to switch scenes
	   Parent newParent = FXMLLoader.load(getClass().getResource("managers.fxml"));
